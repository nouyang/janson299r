...
silent only
cd ~/Documents/299r/janson299r/wk11
...
let s:cpo_save=&cpo
set cpo&vim
cnoremap <buffer> <Plug>L2UCmdTab eLaTeXtoUnicode#CmdTab()
...
setlocal indentkeys=!^F,o,O,e,=end,=else,=catch,=finally,),],}
...
14
normal! zo
let s:l = 415 - ((79 * winheight(0) + 40) / 80)
